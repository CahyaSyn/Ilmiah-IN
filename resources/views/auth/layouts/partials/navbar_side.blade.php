<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
    ...
    <!-- Nav Item - menuManagement -->
    @if (auth()->user()->role == 'admin')
        <li class="nav-item">
            <a class="nav-link {{ request()->route()->getName() == 'managementUser'? 'active': '' }}" href="{{ url('/management-user') }}">
    ...
    <li class="nav-item {{ request()->segment(1) == 'karya-ilmiah' ? 'active' : '' }}">
    ...
    <li class="nav-item {{ request()->segment(1) == 'surat' ? 'active' : '' }}">
